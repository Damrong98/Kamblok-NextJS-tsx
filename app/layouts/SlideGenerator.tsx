...
const promptTemplate = {
  standard: `បង្កើតស្លាយបង្រៀនស្តីពី "{prompt}" ដែលមានរយៈពេលចន្លោះពី ៦០ដល់ ៩០នាទី។`,
  inquiryBased: `បង្កើតស្លាយបង្រៀនបែប Inquiry-Based Learning ស្តីពី "{prompt}" ដែលមានរយៈពេលចន្លោះពី ៦០ដល់ ៩០នាទី។`,
  projectBased: `បង្កើតស្លាយបង្រៀនបែប Project-Based Learning ស្តីពី "{prompt}" ដែលមានរយៈពេលចន្លោះពី ៦០ដល់ ៩០នាទី។`,
};
...
export function SlideGenerator() {
  ...
  const cardTitle = {
    standard: "ស្លាយបង្រៀនស្តង់ដារ",
    inquiryBased: "ស្លាយបង្រៀនបែប IBL",
    projectBased: "ស្លាយបង្រៀនបែប PLB",
  }[selectedTemplate];
          ...
          >
            <CardContent className="grid gap-4">
              ...
              <Select onValueChange={setSelectedTemplate} value={selectedTemplate}>
                ...
                <SelectContent>
                  <SelectItem value="standard">ស្លាយបង្រៀនស្តង់ដារ</SelectItem>
                  <SelectItem value="inquiryBased">ស្លាយបង្រៀនបែប Inquiry-Based Learning</SelectItem>
                  <SelectItem value="projectBased">ស្លាយបង្រៀនបែប Project-Based Learning</SelectItem>
                </SelectContent>
              </Select>
